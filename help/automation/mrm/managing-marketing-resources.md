...
Para cada recurso de marketing administrado mediante Adobe Campaign, puede realizar un seguimiento del estado y el historial en cualquier momento y ver la versión actual.

De forma predeterminada, los recursos de marketing se almacenan en la variable **[!UICONTROL MRM > Marketing resources]** carpeta del explorador de Campaign.

## Agregar un recurso de marketing {#adding-a-marketing-resource}

Para agregar un recurso de marketing, siga los pasos a continuación:

1. Vaya a la **[!UICONTROL Campaigns]** y seleccione **[!UICONTROL Marketing resouces]**.

1. Haga clic en el botón **[!UICONTROL Create]**.
   ![](assets/add-a-mkt-resource.png)
1. Arrastre y suelte el archivo en la ventana Recurso de marketing para cargarlo en el servidor de Campaign. También puede usar la variable **[!UICONTROL Upload file to server...]** vínculo.
...
Utilice la variable **[!UICONTROL Assigned to]** lista desplegable en la **[!UICONTROL Edit]** para seleccionar el operador responsable del recurso.

![](assets/assign-a-mkt-resource.png)

También puede seleccionar los operadores o grupos de operadores a cargo de la validación de recursos y la publicación de recursos. Para acceder a estas opciones, haga clic en el botón  **[!UICONTROL Advanced parameters]** vínculo.
...
Utilice la variable **[!UICONTROL Audit]** para añadir un lector de pruebas y definir una fecha de disponibilidad para el recurso. Más allá de esta fecha, aparece con estado **[!UICONTROL Late]**.
...
Cuando un operador comienza a trabajar con un recurso, se recomienda bloquearlo para evitar que otros operadores lo modifiquen al mismo tiempo. A continuación, se reserva el recurso: permanece accesible, pero otro operador no puede publicarlo ni actualizarlo en el servidor.

Un recurso de marketing solo se puede bloquear si no se ha aprobado.

Para bloquear un recurso, debe hacer clic en el botón **[!UICONTROL Lock]** en el panel de recursos.

![](assets/lock-a-resource.png)


Cuando se haya actualizado el recurso, haga clic en el botón **[!UICONTROL Lock]** en el panel de recursos para que estén disponibles para todos los operadores de nuevo.

Un mensaje especial notifica a los operadores que intentan acceder a él:

![](assets/mkt-resource-locked.png)

La variable **[!UICONTROL Tracking]** indica el nombre del operador que ha bloqueado el recurso.
...
Para cada recurso, la variable **[!UICONTROL Forum]** permite a los participantes compartir información.

![](assets/mkt-resource-forum.png)

Obtenga más información en la [Foros de debate](discussion-forums.md) para obtener más información.
...
Para aprobar un recurso, haga clic en el botón **[!UICONTROL Approve the resource]** en su panel.
...
Los recursos de marketing se pueden asociar a las campañas, siempre que esta característica se haya seleccionado en la variable [plantilla de campaña](../campaigns/marketing-campaign-templates.md).
...
Utilice la variable **[!UICONTROL Details]** para editar y previsualizar el recurso.

### Añadir un recurso de marketing a una descripción de entrega {#adding-a-marketing-resource-to-a-delivery-outline}
...
Introduzca el nombre del recurso y selecciónelo en el **Recurso de marketing** lista desplegable.
...
Para asociar un recurso de marketing a un inventario de existencias, siga los pasos a continuación:

1. Edite un inventario o cree un nuevo inventario. Obtenga más información sobre las existencias en [esta sección](../campaigns/providers--stocks-and-budgets.md#stock-management).

1. Añada una línea de stock y seleccione el recurso de marketing correspondiente.

   ![](assets/mkt-resource-in-a-stock-line.png)

   Puede editar el recurso seleccionado mediante el **[!UICONTROL Edit the link]** a la derecha del recurso una vez que se ha seleccionado.
