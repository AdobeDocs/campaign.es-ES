...
| **Replicar datos de FDAC inmediatamente** (ffdaReplicate) | Instalado de forma predeterminada solo en [implementaciones de Campaign Enterprise (FDAC)](../../v8/architecture/enterprise-deployment.md) | Replica los datos XS de una cuenta externa determinada. [Más información sobre la replicación de datos](../../v8/architecture/replication.md) |
| **Replicar cola de nmsDelivery** (ffdaReplicateQueueDelivery) | Instalado de forma predeterminada solo en [implementaciones de Campaign Enterprise (FDAC)](../../v8/architecture/enterprise-deployment.md) | Cola para la tabla `nms:delivery`. [Más información sobre la replicación de datos](../../v8/architecture/replication.md) |
| **Replicar cola nmsDlvExclusion** (ffdaReplicateQueueDlvExclusion) | Instalado de forma predeterminada solo en [implementaciones de Campaign Enterprise (FDAC)](../../v8/architecture/enterprise-deployment.md) | Cola para la tabla `nms:dlvExclusion`. [Más información sobre la replicación de datos](../../v8/architecture/replication.md) |
| **Replicar cola nmsDlvMidRemoteIdRel** (ffdaReplicateQueueDlvMidRemoteIdRel) | Instalado de forma predeterminada solo en [implementaciones de Campaign Enterprise (FDAC)](../../v8/architecture/enterprise-deployment.md) | Cola para la tabla `nms:dlvRemoteIdRel`. [Más información sobre la replicación de datos](../../v8/architecture/replication.md) |
| **Replicar cola nmsTrackingUrl** (ffdaReplicateQueueTrackingUrl)<br/>**Replicar cola nmsTrackingUrl en simultaneidad** (ffdaReplicateQueueTrackingUrl_2) | Instalado de forma predeterminada solo en [implementaciones de Campaign Enterprise (FDAC)](../../v8/architecture/enterprise-deployment.md) | Colas en simultaneidad para la tabla `nms:trackingUrl`, que utilizan dos flujos de trabajo para mejorar la eficacia al procesar solicitudes basadas en prioridades diferentes. [Más información sobre la replicación de datos](../../v8/architecture/replication.md) |
| **Replicar tablas de referencia** (ffdaReplicateReferenceTables) | Instalado de forma predeterminada solo en [implementaciones de Campaign Enterprise (FDAC)](../../v8/architecture/enterprise-deployment.md) | Realiza la replicación automática de tablas integradas que deben estar presentes en la base de datos local de Campaign (PostgreSQL) y en la base de datos en la nube ([!DNL Snowflake]). Está programado para ejecutarse cada hora, a diario. Si existe el campo **lastModified**, la replicación se produce de forma incremental; de lo contrario, se replica toda la tabla. [Más información sobre la replicación de datos](../../v8/architecture/replication.md) |
| **Replicar datos de ensayo** (ffdaReplicateStagingData) | Instalado de forma predeterminada solo en [implementaciones de Campaign Enterprise (FDAC)](../../v8/architecture/enterprise-deployment.md) | Replica los datos de ensayo para llamadas unitarias. Está programado para ejecutarse cada hora, a diario. [Más información sobre la replicación de datos](../../v8/architecture/replication.md) |
