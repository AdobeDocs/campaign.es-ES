...
|------|--------|-----------|
| **Limpieza de alias** (aliasCleansing) | Instalado de forma predeterminada | Este flujo de trabajo estandariza los valores de enumeración. Se activa cada día a la 3 de la mañana de forma predeterminada. |
