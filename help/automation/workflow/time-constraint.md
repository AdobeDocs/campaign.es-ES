...
Introduzca la etiqueta para la actividad y especifique el lapso de tiempo durante el cual se permite ejecutar la tarea de flujo de trabajo. El flujo de trabajo solo se ejecutará durante esta ventana de ejecución definida y permanecerá en pausa fuera de ella.
