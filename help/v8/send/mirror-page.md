...
1. En el **Administración de página espejo** , marque la **[!UICONTROL Mode]** lista desplegable.
...
1. Una vez entregado el envío, ábralo y busque su **[!UICONTROL Delivery]** pestaña.

1. Seleccione un destinatario y haga clic en **[!UICONTROL Display the mirror page for this message...]** vínculo.
