...
![](../assets/do-not-localize/book.png) Obtenga información sobre cómo crear y publicar formularios web en la documentación de  [Campaign Classic v7](https://experienceleague.adobe.com/docs/campaign-classic/using/designing-content/web-forms/about-web-forms.html?lang=en#designing-content)
...
![](../assets/do-not-localize/book.png) Obtenga información sobre cómo crear y publicar aplicaciones web en la documentación de  [Campaign Classic v7](https://experienceleague.adobe.com/docs/campaign-classic/using/designing-content/web-applications/about-web-applications.html?lang=en#designing-content)
