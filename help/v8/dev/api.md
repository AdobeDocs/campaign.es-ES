...
* API genéricas de acceso a datos para consultar los datos del modelo de datos mediante los métodos queryDef y NLWS. Obtenga más información en [Consulte la base de datos con queryDef](query-api.md).
...
* [Consultar la base de datos con queryDef](query-api.md)
