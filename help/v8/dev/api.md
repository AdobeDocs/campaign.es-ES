...
Puede usar [las API de JavaScript de Campaign](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"} para escribir en la base de datos de la nube de Campaign o leer desde la base de datos:
