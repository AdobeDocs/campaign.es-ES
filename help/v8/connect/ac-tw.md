...
El **Administración de redes sociales (Marketing social)** Este módulo le permite interactuar con sus clientes a través de Twitter. Utilice esta capacidad para lo siguiente:

* Publicar mensajes y enviar DM: utilice Adobe Campaign Social Marketing para publicar mensajes en Twitter. También puede enviar mensajes directos a todos sus seguidores. 
...
![](../assets/do-not-localize/speech.png) Como usuario de Managed Cloud Services, [Adobe de contacto](../start/campaign-faq.md#support) para conectar Campaign con Twitter. El  **Administración de redes sociales (Marketing social)** El complemento debe estar instalado en su entorno, a través del paquete dedicado, y la cuenta externa de Twitter debe estar configurada.
...
Campaign utiliza la versión 1.1 de la API de Twitter. Para utilizarlo, debe solicitar el acceso elevado a través del portal para desarrolladores. Obtenga más información sobre el acceso elevado de Twitter [en esta página](https://developer.twitter.com/en/portal/products/elevated){target="_blank"}.
...
1. Conectar a [Twitter developer portal](https://developer.twitter.com/en/apps).
...
1. Introduzca la etiqueta y el nombre interno del servicio.
   ...
   >[!CAUTION]
   >
   >El **[!UICONTROL Internal name]** El nombre del servicio debe ser exactamente el mismo nombre que su cuenta de Twitter.
...
1. De forma predeterminada, los seguidores se guardan en la carpeta **[!UICONTROL Visitors]**. Puede seleccionar otra ubicación en el **[!UICONTROL Visitor folder]** field. [Más información](../send/twitter.md#direct-tw-messages)
   ...
   >[!NOTE]
   >
   >El **[!UICONTROL Synchronize subscriptions]** esta opción está activada de forma predeterminada: recupera automáticamente la lista de sus seguidores de Twitter para que pueda [enviarles mensajes directos](../send/twitter.md#direct-tw-messages). La sincronización se realiza mediante una [flujo de trabajo técnico dedicado](#synchro-tw-accounts).
...
El **[!UICONTROL Synchronization of Twitter accounts]** flujo de trabajo técnico sincroniza las cuentas de Twitter en Adobe Campaign. Este flujo de trabajo recupera la lista de seguidores de Twitter para que pueda enviarles mensajes directos. [Más información](../send/twitter.md#direct-tw-messages)
...
>[!CAUTION]
>
>Para recuperar la lista de suscriptores de Twitter, haga lo siguiente **[!UICONTROL Twitter account synchronization]** La opción debe activarse para el servicio vinculado a la cuenta. [Más información](#create-tw-service)

Los seguidores se almacenan en una tabla específica: la tabla de visitantes. Para mostrar la lista de seguidores de Twitter, vaya a **[!UICONTROL Profiles and Targets > Visitors]**.
...
Una vez que se haya realizado esta configuración, puede publicar tweets en sus cuentas de Twitter y enviar mensajes directos a sus seguidores. [Más información](../send/twitter.md)

## Creación de una cuenta de prueba en Twitter {#tw-test-account}

Además de la cuenta de Twitter, cree una cuenta privada de Twitter que se pueda utilizar para enviar [pruebas de tuit](../send/twitter.md#send-tw-proofs). Para realizar esto, siga los pasos a continuación:
