---
title: Prácticas recomendadas para envíos
...
### Entrega y mantenimiento {#delivery-maintenance}

El mantenimiento regular de las entregas es esencial para un rendimiento óptimo de la plataforma.

+++ **Lea algunas prácticas recomendadas**

* **Elimine los envíos erróneos e innecesarios**: no mantenga los envíos en estado de error en la instancia, ya que esto mantiene las tablas temporales e afecta al rendimiento. Elimine con regularidad las entregas que ya no sean necesarios para liberar recursos del sistema.

* **Limpiar destinatarios inactivos**: los destinatarios inactivos en los últimos 12 meses deben eliminarse de la base de datos para mantener la calidad de la dirección. Los ISP desactivan las direcciones después de un periodo de inactividad y los mensajes rechazados se envían a los remitentes para informarles sobre este nuevo estado. La limpieza regular de listas mejora la capacidad de entrega y reduce los costes.

* **Programe entregas grandes con prudencia**: no programe entregas grandes juntos. Coordine la programación de las entregas con los demás miembros de su equipo para distribuir la carga de forma uniforme en el sistema. Cuando se envían varias entregas grandes simultáneamente, esto puede afectar al rendimiento general de la plataforma.
...
En el asistente de envíos, la subpestaña **[!UICONTROL Preview]** permite ver el renderizado de cada contenido para un destinatario. Los campos de personalización y los elementos condicionales del contenido se sustituyen por la información correspondiente del perfil seleccionado. [Más información](../send/preview-and-proof.md).
...
El seguimiento de mensajes está habilitado de forma predeterminada. Para configurar direcciones URL, seleccione la opción Mostrar direcciones URL en la sección inferior del asistente de envíos. Por cada dirección URL del mensaje, puede elegir si desea activar el seguimiento.


[Más información sobre las funcionalidades de seguimiento](../send/tracking.md)
