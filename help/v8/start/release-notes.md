...
* El archivo setup-client.exe se ha reemplazado por un archivo ac-client.msi. Esto proporciona a los administradores una forma más sencilla de realizar actualizaciones masivas sin la intervención del usuario.
