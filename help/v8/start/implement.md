...
>
>Si necesita utilizar un complemento de Campaign o una funcionalidad específica que no se haya aprovisionado por usted, debe ponerse en contacto con **Adobe Customer Care**.
...
1. Configuración de reglas de tipología
   ...
   [!DNL :arrow_upper_right:] [Obtenga más información sobre tipologías y administración de la fatiga](https://experienceleague.adobe.com/docs/campaign-classic/using/orchestrating-campaigns/campaign-optimization/about-campaign-typologies.html?lang=es#orchestrating-campaigns)
