...
* Se han resuelto problemas de conexión SFTP provocados por versiones `libcurl` y `libssh2` obsoletas, lo que garantiza la compatibilidad con servidores SFTP alojados por Azure. (NEO-84038)
...
Procesamiento de solicitudes HTTP mejorado en el módulo web Apache para reforzar la seguridad y evitar posibles vulnerabilidades en la gestión de solicitudes. (NEO-85824)
