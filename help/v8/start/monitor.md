...
**Envíos de SMS**: rastree el estado de envío de SMS y supervise las métricas clave en el panel de envío de SMS. Más información sobre la [supervisión de SMS](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/sms/sms-monitor).

**Notificaciones push**: supervise las entregas de notificaciones push para garantizar que lleguen a los usuarios de su aplicación móvil de forma eficaz. Más información sobre la [supervisión de notificaciones push](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/push/push#push-test).
...
Más información sobre [Pista de auditoría](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/analytics/audit-trail)
...
Más información sobre [flujos de trabajo técnicos](https://experienceleague.adobe.com/en/docs/campaign/automation/workflows/introduction/wf-type/technical-workflows#_blank)
...
Más información sobre [informes de envío](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/analytics/reports/ac-reports/delivery-reports)
...
Más información sobre [informes globales](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/analytics/reports/ac-reports/global-reports)
...
- [Configuración y envío de entregas](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/validate/configure-and-send)
- [Introducción a la creación de informes](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/analytics/reports/gs-reporting)
