...
Conozca los aspectos básicos para comenzar a trabajar con Adobe Campaign v8, desde la instalación y conexión hasta la creación de sus primeras campañas.

+++ ¿Qué es Adobe Campaign v8?

Adobe Campaign v8 es una potente plataforma de automatización de marketing entre canales que le ayuda a crear, coordinar y ofrecer campañas personalizadas en canales de correo electrónico, móviles, sociales y sin conexión. Combina una sólida base de datos de marketing, un motor de orquestación de campañas y funciones de interacción en tiempo real para atraer a los clientes a lo largo de su recorrido.

**Funciones clave:** administración de campañas multicanal, segmentación y direccionamiento de audiencias, automatización de flujos de trabajo, personalización a escala, mensajería en tiempo real y por lotes, informes y análisis, integración con Adobe Experience Cloud.

**Lo que hace que la versión 8 sea única:** arquitectura nativa de la nube (solo Cloud Services administrados), rendimiento a escala empresarial con tecnología de base de datos de Snowflake, actualizaciones automáticas, seguridad mejorada e integración bidireccional con Adobe Experience Platform.

**Ideal para:** equipos de marketing empresarial que administran campañas complejas y de gran volumen en varios canales y puntos de contacto de clientes.

**Temas relacionados:**

[Descripción del producto de la versión 8 de Campaign](https://helpx.adobe.com/es/legal/product-descriptions/adobe-campaign-managed-cloud-services.html){target="_blank"} | [Novedades de la versión 8](whats-new.md) | [Guía de introducción](get-started.md)
...
[Instalar la consola del cliente](connect.md) | [Interfaz de usuario de Campaign](campaign-ui.md) | [Permisos de usuario](gs-permissions.md)
...
Campaign ofrece varios métodos de segmentación para seleccionar la audiencia adecuada para sus mensajes:

**Métodos de segmentación:**

* **Editor de consultas**: cree audiencias con filtros visuales en atributos de destinatario, comportamientos o datos demográficos
* **Listas** - Usar listas de destinatarios estáticas o dinámicas predefinidas
* **Importación de archivos**: cargue archivos de destinatarios externos para campañas únicas
* **Flujos de trabajo**: cree una lógica de segmentación compleja con actividades de consulta, división y enriquecimiento
* **Filtros predefinidos** - Aplicar filtros listos para usar (clientes activos, suscriptores, VIP)
* **Segmentos de Adobe Experience Platform**: aproveche perfiles unificados y segmentos en tiempo real

Puede combinar varios criterios (ubicación, historial de compras, participación) y utilizar exclusiones, intersecciones o uniones para refinar la audiencia.

**Temas relacionados:**

[Definir audiencias en la versión 8 de Campaign](../audiences/gs-audiences.md) | [Editor de consultas](query-editor.md) | [Asignaciones de público objetivo](../audiences/target-mappings.md)

+++

+++ ¿Cómo se crea y se envía un primer correo electrónico?

La creación del primer correo electrónico en Campaign v8 es sencilla. Empiece desde una plantilla, seleccione la audiencia de destino, diseñe el contenido con personalización, pruébelo con pruebas y, a continuación, envíe. Campaign ofrece dos interfaces para la creación de correos electrónicos: la **consola de cliente** con todas las funciones para usuarios avanzados y la moderna **IU web de Campaign** para generar correos electrónicos de forma más rápida e intuitiva.

**5 pasos clave:**

1. **Crear envío** - Comience desde una plantilla de correo electrónico o cree desde cero
2. **Definir audiencia**: seleccione destinatarios mediante consultas, listas o flujos de trabajo
3. **Diseñar contenido**: use el diseñador de correo electrónico para crear su mensaje con campos de personalización
4. **Enviar pruebas de prueba**: valide el procesamiento y el contenido entre dispositivos y clientes de correo electrónico
5. **Analizar y enviar**: ejecuta el análisis de envío para comprobar si hay errores y, a continuación, envía el correo electrónico

**Temas relacionados:**

[Diseño y validación de correo electrónico](../send/email.md) | [Crear la primera entrega](create-message.md) | [Plantillas de envío](../send/create-templates.md) | [Personalizar contenido](../send/personalize.md)
...
[Versiones y actualizaciones de Campaign](upgrades.md) | [Actualizar la consola del cliente](connect.md#upgrade-ac-console) | [Notas de la versión](release-notes.md)
...
[Funciones clave de Campaign v8](whats-new.md) | [Arquitectura de Campaign v8](../architecture/architecture.md) | [Matriz de capacidades](https://experienceleague.adobe.com/es/docs/campaign-web/v8/start/capability-matrix){target="_blank"} | [Protecciones y limitaciones](ac-guardrails.md)

+++

+++ ¿Debería migrar de Campaign Classic v7 o Campaign Standard a v8?

La versión 8 de Campaign es la plataforma de Adobe, ideal para organizaciones que necesitan campañas de gran volumen (20 millones de operaciones por hora), una interfaz de usuario web moderna, beneficios nativos de la nube y compatibilidad a largo plazo.
...
[De Campaign Classic v7 a v8](v7-to-v8.md) | [Guía de transición de Campaign Standard](https://experienceleague.adobe.com/es/docs/campaign-web/v8/start/acs-migration){target="_blank"} | [Matriz de capacidades](https://experienceleague.adobe.com/es/docs/campaign-web/v8/start/capability-matrix){target="_blank"}
...
La versión 8 de Campaign incorpora la mayoría de las funciones de la versión 7/Standard con mejoras, pero algunos términos y características difieren. A continuación encontrará un resumen de los cambios clave.
...
[Matriz de capacidades](https://experienceleague.adobe.com/es/docs/campaign-web/v8/start/capability-matrix){target="_blank"} | [Guía de transición de las versiones 7 a 8](v7-to-v8.md) | [Transición de Campaign Standard a las versiones 8](https://experienceleague.adobe.com/es/docs/campaign-web/v8/start/acs-migration){target="_blank"}
...
Los perfiles de prueba (direcciones semilla) permiten dirigirse a destinatarios que no coinciden con los criterios de objetivo definidos, lo que permite probar el envío antes de enviarlo a la audiencia principal. Añádalos a través de **[!UICONTROL Seed addresses]** en las propiedades de entrega o utilice la carpeta **[!UICONTROL Seed addresses]**.
...
Más información sobre la [Actividad de exclusión](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/exclusion.html?lang=es){target="_blank"}
...
+++ ¿Cómo puedo personalizar las líneas de asunto del correo electrónico?

Las líneas de asunto personalizadas aumentan considerablemente las tasas de apertura. Campaign le permite insertar datos de destinatarios de forma dinámica, aplicar lógica condicional y probar variaciones para optimizar la participación.

**Técnicas de Personalization:**

* **Campos básicos** - Insertar nombre, apellido, ubicación: `"<%@ firstName %>, exclusive offer for you"`
* **Contenido condicional** - Diferentes temas por segmento: `"<% if (recipient.gender == 'F') { %>Special offer just for you<% } else { %>Exclusive deal inside<% } %>"`
* **Datos dinámicos**: incluye el historial de compras, los puntos de lealtad o la información de la cuenta
* **Emojis** - Agregar atractivo visual (primero prueba entre clientes de correo electrónico)

**Prácticas recomendadas:** No sobrepase los 50 caracteres, pruebe los tokens de personalización antes de enviarlos, utilice pruebas A/B para optimizar, evite palabras de déclencheur de correo no deseado, incluya propuestas de valor o urgencia.

**Temas relacionados:**

[Campos de personalización](../send/personalization-fields.md) | [Contenido condicional](../send/conditions.md)
...
[Envíos multilingües (interfaz de usuario web)](https://experienceleague.adobe.com/es/docs/campaign-web/v8/msg/multilingual){target="_blank"} | [Contenido condicional (consola del cliente)](../send/conditions.md)
...
Sí, pero **solo a través de la IU web de Campaign**. AI Assistant, con tecnología Microsoft Azure OpenAI y Adobe Firefly, ayuda a crear contenido profesional y coherente con la marca en correos electrónicos, SMS y notificaciones push.
...
[Introducción a las entregas](../send/about-deliverability.md) | [Contenido del mensaje de control](../send/control-message-content.md) | [Supervisar las entregas](../send/monitoring-deliverability.md) | [SpamAssassin](../send/spamassassin.md)
...
Obtenga más información en la [Guía de direcciones semilla](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/action-activities/delivery-control.html?lang=es){target="_blank"}
...
+++ ¿Puedo ejecutar pruebas A/B en mis envíos?

¡Sí! Campaign le permite ejecutar pruebas A/B (también denominadas pruebas divididas) para optimizar las líneas de asunto, el contenido, los nombres de los remitentes, los tiempos de envío y mucho más comparando el rendimiento en diferentes variantes.

**Lo que puede probar:**

* **Líneas de asunto**: compare las tasas de apertura en diferentes temas
* **Variaciones de contenido**: pruebe diferentes diseños, llamadas a la acción o imágenes
* **Información del remitente** - Comprobar el nombre del remitente o el impacto de la dirección remitente
* **Tiempo de envío**: identifique las ventanas de envío óptimas
* **Estrategias de Personalization**: compare contenido personalizado con contenido genérico

**Cómo funciona:**

1. Cree su envío y defina las variantes de prueba (hasta 3)
2. Divida la audiencia (normalmente del 10 % al 20 % para los segmentos de prueba)
3. Campaign envía variantes para probar segmentos y rastrear el rendimiento
4. La variante ganadora se envía automáticamente a la audiencia restante (o se selecciona manualmente el ganador)

**Disponible en:** Tanto la interfaz de usuario web de Campaign como la consola de cliente. La interfaz de usuario web ofrece una configuración más sencilla con comparación visual.

**Temas relacionados:**

[Análisis de envío](../send/delivery-analysis.md) | [Envío y seguimiento de envíos](../send/send.md)
...
Obtenga más información en la [Guía de reglas de tipología](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/campaign-typologies.html?lang=es){target="_blank"}
...
[Guía de seguimiento de vínculos](../send/tracking.md) | [Prácticas recomendadas de seguimiento](../send/send.md)
...
[Supervisión de envíos](../send/send.md) | [Guía de seguimiento](../send/tracking.md)
...
[Crear un flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/build-a-workflow.html?lang=es){target="_blank"} | [Actividades de flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/about-activities.html){target="_blank"} | [Prácticas recomendadas de flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/workflow-best-practices.html?lang=es){target="_blank"} | [Casos de uso de flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/about-workflow-use-cases.html){target="_blank"}

+++

+++ ¿Cómo puedo automatizar las campañas recurrentes?

Use flujos de trabajo con la actividad **Planificador** para automatizar campañas que se ejecuten en una programación regular: a intervalos diarios, semanales, mensuales o personalizados. Perfecto para correos electrónicos de bienvenida, mensajes de cumpleaños, envíos de boletines informativos, recordatorios de carros de compras abandonados e informes regulares.

**Patrón de configuración:**

1. **Programador** - Definir frecuencia (por ejemplo, &quot;Todos los lunes a las 9 a. m.&quot;)
2. **Consulta** - Seleccionar audiencia de destino con criterios dinámicos
3. **Enriquecimiento** (opcional): agregar datos de personalización
4. **Envío**: configura tu mensaje (correo electrónico, SMS, push)
5. **Fin**: el flujo de trabajo se completa y espera a la siguiente ejecución programada

**Campañas automatizadas comunes:**

* **Serie de bienvenida**: flujo de trabajo diario para enviar correos electrónicos de incorporación a los nuevos suscriptores
* **Correos electrónicos de cumpleaños**: compruebe a diario si hay destinatarios con cumpleaños y envíe un mensaje personalizado
* **Reparticipación**: segmentación semanal de usuarios inactivos con ofertas de recuperación
* **Boletines** - Distribución de contenido semanal o mensual programada
* **Abandono del carro de compras**: flujo de trabajo por hora para identificar y enviar mensajes a los abandonadores del carro de compras

**Sugerencia:** Use el tipo **envío recurrente** en flujos de trabajo para rastrear cada ejecución por separado y mantener el sistema de informes histórico.

**Temas relacionados:**

[Actividad del programador](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/flow-control-activities/scheduler.html?lang=es){target="_blank"} | [Envíos recurrentes](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/deliveries/sending-a-birthday-email.html){target="_blank"} | [Automatización de la campaña](https://experienceleague.adobe.com/docs/campaign/automation/home.html?lang=es){target="_blank"}
...
[Prácticas recomendadas de importación](../start/import.md) | [Actividad de carga de datos](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/action-activities/data-loading-file.html?lang=es){target="_blank"} | [Flujo de trabajo de importación recurrente](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/data-management/recurring-import-workflow.html?lang=es){target="_blank"}

+++

+++ ¿Cómo puedo garantizar la calidad de los datos durante las importaciones?

La calidad de los datos es crítica para una ejecución correcta de la campaña. Los datos deficientes provocan fallos de entrega, desperdicio de recursos y riesgos de cumplimiento normativo. Campaign proporciona herramientas para validar, limpiar y enriquecer datos durante el proceso de importación.

**Pasos de validación de datos:**

1. **Validación previa a la importación**: compruebe el formato de archivo, la codificación (UTF-8), la asignación de columnas y los campos obligatorios presentes
2. **Anulación de duplicación**: use la actividad **[!UICONTROL Deduplication]** para identificar y controlar duplicados por correo electrónico, ID o claves personalizadas
3. **Enriquecimiento de datos** - Utilice la actividad **[!UICONTROL Enrichment]** para agregar los datos que faltan de las tablas de Campaign existentes
4. **Normalización de formato**: Normalice números de teléfono, direcciones de correo electrónico, fechas y códigos de país con JavaScript o enriquecimiento
5. **Reglas de validación**: aplique restricciones (formato de correo electrónico válido, campos obligatorios e intervalos de valores)

**Problemas y correcciones comunes:**

* **Errores de codificación de caracteres** → Utilizar siempre la codificación UTF-8
* **El formato de fecha no coincide** → Estandarizar al formato AAAA-MM-DD
* **Direcciones de correo electrónico no válidas** → Usar reglas de validación o JavaScript para filtrar
* **Registros duplicados** → Incluya siempre la actividad de anulación de duplicación antes de las actualizaciones
* **Faltan campos obligatorios** → Establecer valores predeterminados o rechazar registros incompletos

**Práctica recomendada:** Cree una plantilla de flujo de trabajo de &quot;calidad de datos&quot; reutilizable con actividades estándar de validación y limpieza que pueda aplicar a todas las importaciones.

**Temas relacionados:**

[Guía de calidad de datos](../start/import.md) | [Actividad de deduplicación](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/deduplication.html?lang=es){target="_blank"} | [Actividad de enriquecimiento](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/enrichment.html?lang=es){target="_blank"}
...
[Biblioteca de casos de uso del flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/about-workflow-use-cases.html){target="_blank"} | [Generar un flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/build-a-workflow.html?lang=es){target="_blank"} | [Prácticas recomendadas del flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/workflow-best-practices.html?lang=es){target="_blank"}
...
[Actividad dividida](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/split.html?lang=es){target="_blank"} | [Guía de pruebas A/B](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/deliveries/a-b-testing.html){target="_blank"}
...
[Actividades de segmentación](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/targeting-activities.html?lang=es){target="_blank"} | [Control de flujo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/flow-control-activities/flow-control-activities.html?lang=es){target="_blank"} | [Actividades de acción](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/action-activities/action-activities.html?lang=es){target="_blank"}
...
[Guía de prácticas recomendadas de flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/workflow-best-practices.html?lang=es){target="_blank"} | [Monitorizar flujos de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/monitoring-workflows/monitor-workflow-execution.html?lang=es){target="_blank"}
...
[Cambiar idioma en la IU web de Campaign](https://experienceleague.adobe.com/es/docs/campaign-web/v8/start/connect-to-campaign#language-pref){target="_blank"} | [Introducción a la consola del cliente de Campaign](connect.md)
...
[Documentación de Panel de control de Campaign](https://experienceleague.adobe.com/es/docs/control-panel/using/control-panel-home){target="_blank"} | [Vídeos de tutorial de Panel de control de Campaign](https://experienceleague.adobe.com/es/docs/control-panel-learn/tutorials/control-panel-overview){target="_blank"}

+++

+++ ¿Cómo puedo comprobar que mis operadores y permisos siguen las prácticas recomendadas de seguridad?

Adobe Campaign v8 ofrece la capacidad de comparar toda la configuración actual de cuentas administrativas de nivel superior y cuentas privilegiadas con los valores predeterminados seguros recomendados.

* **Configuración actual (visibilidad completa):** Toda la configuración de las cuentas administrativas y con privilegios se puede revisar en **[!UICONTROL Administration]** > **[!UICONTROL Access management]** (consola de cliente o interfaz de usuario web de Campaign): **[!UICONTROL Operators]**, **[!UICONTROL Operator groups]**, **[!UICONTROL Named rights]** (por ejemplo, ADMINISTRACIÓN, ADMINISTRACIÓN DE APROBACIÓN) y permisos de nivel de carpeta. Los administradores de productos también pueden revisar la configuración a nivel de instancia en [Panel de control de Campaign de Campaign](https://experienceleague.adobe.com/docs/control-panel/using/control-panel-home.html?lang=es){target="_blank"} (lista de permitidos IP, permisos de URL, detalles de instancias y más).
* **Valores predeterminados seguros recomendados:** Las [Directrices de seguridad](../config/security.md) definen la línea de base segura recomendada para las cuentas administrativas y con privilegios, entre las que se incluyen: crear suficientes grupos de seguridad, asignar los derechos de acceso adecuados por operador y limitar el uso del operador de administración y del grupo de administración. Si corresponde, consulte también el [complemento de seguridad mejorada](../config/enhanced-security.md) para proteger la red y el cifrado.
* **Comparación:** Los administradores comparan su configuración actual con estas recomendaciones documentadas para identificar brechas y alinearse con los valores predeterminados seguros.

**Temas relacionados:**

[Introducción a los permisos](gs-permissions.md) | [Directrices de seguridad](../config/security.md) | [Complemento de seguridad mejorada](../config/enhanced-security.md)
...
[Seguimiento y monitorización de entregas](../send/tracking.md) | [Configuración de vínculos rastreados](../send/tracked-links.md) | [Seguimiento de pruebas](../send/testing-tracking.md)
...
Los requisitos de disponibilidad y conexión de FDA dependen de la implementación y las licencias. Revise las bases de datos compatibles y las versiones requeridas en la matriz de compatibilidad.

**Temas relacionados:**

[Configurar conexiones de FDA](../connect/fda.md) | [Matriz de compatibilidad](compatibility-matrix.md)
...
Ver [Configurar conexiones de FDA](../connect/fda.md)
...
**Si el problema persiste (avanzado):**

Cierre la consola del cliente y, a continuación, elimine manualmente los archivos de caché local del perfil de usuario.

**Limpieza manual de la caché (Windows):**

1. En la consola del cliente, seleccione **[!UICONTROL File]** > **[!UICONTROL Clear the local cache...]**.
2. Cierre la sesión y la consola de cliente.
3. Vaya a la ubicación de caché en función de la versión de Windows. Para Windows 10: `C:\Users\<Username>\AppData\Roaming\Neolane\NL_5\`
4. Eliminar los `nlclient-config-<alphanumerical>.xml` archivos y sus carpetas asociadas.

>[!IMPORTANT]
>
>No elimine `nlclient_cnx.xml`.

El Soporte de Adobe puede confirmar la ubicación de caché correcta para su versión y sistema operativo y guiarle a través de una limpieza manual segura.

Obtenga más información en [Instalar y configurar la consola de cliente](connect.md)
...
[Conectarse a la versión 8 de Campaign](connect.md) | [Funciones no admitidas en la versión 8](v7-to-v8.md#gs-removed)
...
[Introducción a los informes](../reporting/gs-reporting.md) | [Informes de interfaz de usuario web de Campaign](https://experienceleague.adobe.com/en/docs/campaign-web/v8/reports/gs-reports){target="_blank"}
...
[Informes personalizados](../reporting/custom-reports.md) | [Informes de interfaz de usuario web de Campaign](https://experienceleague.adobe.com/en/docs/campaign-web/v8/reports/gs-reports){target="_blank"}
...
[Tabla de destinatarios personalizada](../dev/custom-recipient.md) | [Asignaciones de destinatarios](../audiences/target-mappings.md)
...
[Editor de consultas](../start/query-editor.md) | [Actividad de consultas](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/query.html?lang=es){target="_blank"}
...
Más información en [Trabajar con paquetes de datos](../dev/packages.md)
...
Ver [flujos de trabajo de control mediante API](../dev/api/controlling-a-workflow.md)
...
Campaign elimina automáticamente todos los datos vinculados a un interesado: perfil de destinatario, registros de envío y seguimiento, datos personalizados con relaciones de propiedad e historial de suscripción.
...
* **[Ayuda de Experience League](https://experienceleague.adobe.com/es/browse/campaign/campaign-v8){target="_blank"}** - Recursos de ayuda para Campaign v8 (interfaz de usuario web y consola de cliente)
