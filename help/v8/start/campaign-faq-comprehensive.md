...
* **[Panel de flujo de trabajo](https://experienceleague.adobe.com/es/docs/campaign/automation/workflows/monitoring-workflows/monitor-workflow-execution){target="_blank"}**: vea el estado en tiempo real, el progreso y los errores de cada actividad de flujo de trabajo
...
[Cree su primer envío](create-message.md) | [Trabajar con plantillas de envío](../send/create-templates.md) | [Prácticas recomendadas de envío](delivery-best-practices.md) | [Defina el contenido del correo electrónico](../send/defining-the-email-content.md) | [Vista previa y pruebas](../send/preview-and-proof.md) | [Configurar y enviar](../send/configure-and-send.md) | [Personalizar contenido](../send/personalize.md)
...
[Introducción a SMS](../send/sms/sms.md) | [Configuración de envío de SMS](../send/sms/sms-delivery-settings.md) | [Configuración de cuenta externa SMPP](../send/sms/smpp-external-account.md) | [Crear un envío de SMS](../send/sms/create-sms.md) | [Contenido de SMS](../send/sms/sms-content.md) | [Enviar pruebas de SMS](../send/sms/sms-proofs.md) | [Monitorizar SMS](../send/sms/sms-monitor.md)
...
[Crear y enviar notificaciones push](../send/push.md) | [Configurar el canal de notificaciones push](../send/push-settings.md) | [Diseñe una inserción enriquecida de Android](../send/rich-push-android.md) | [Diseñe una inserción enriquecida de iOS](../send/rich-push-ios.md) | [Configurar con recopilación de datos](../send/push-data-collection.md) | [Seguimiento y monitorización](tracking.md)
...
[De Campaign Classic v7 a v8](v7-to-v8.md) | [Guía de transición de v7 a v8](https://experienceleague.adobe.com/es/docs/campaign/campaign-v8/new/v7-to-v8){target="_blank"} | [De Campaign Standard a la versión 8](acs-to-v8.md) | [Transición de Campaign Standard](https://experienceleague.adobe.com/es/docs/campaign-web/v8/start/acs-migration){target="_blank"} | [Guía de adopción de Campaign v8](https://experienceleague.adobe.com/es/docs/campaign-web/acs-to-ac/home){target="_blank"} | [Matriz de capacidades de Campaign v8](https://experienceleague.adobe.com/es/docs/campaign-web/v8/start/capability-matrix){target="_blank"}
...
**Para usuarios de Campaign Classic v7:** [De Campaign Classic v7 a v8](v7-to-v8.md) | [Guía detallada de las versiones 7 a 8](https://experienceleague.adobe.com/es/docs/campaign/campaign-v8/new/v7-to-v8){target="_blank"}

**Para usuarios de Campaign Standard:** [Transición de Campaign Standard a la versión 8](https://experienceleague.adobe.com/es/docs/campaign-web/v8/start/acs-migration){target="_blank"} | [Guía de adopción de Campaign v8](https://experienceleague.adobe.com/es/docs/campaign-web/acs-to-ac/home){target="_blank"} | [Información general de Campaign Standard a la versión 8](https://experienceleague.adobe.com/es/docs/campaign-web/acs-to-ac/overview){target="_blank"} | [Introducción para especialistas en marketing](https://experienceleague.adobe.com/es/docs/campaign-web/acs-to-ac/marketers){target="_blank"} | [Introducción para administradores/desarrolladores](https://experienceleague.adobe.com/es/docs/campaign-web/acs-to-ac/admin-developers){target="_blank"}

**Recursos generales:** [Matriz de capacidades de Campaign v8](https://experienceleague.adobe.com/es/docs/campaign-web/v8/start/capability-matrix){target="_blank"}
...
La migración de su entorno local o híbrido de Campaign Classic v7 a Adobe Managed Services suele ser un paso estratégico antes de la transición a Campaign v8. Esta migración ofrece beneficios inmediatos al tiempo que establece las bases para la futura adopción de la versión 8 de.

**¿Por qué migrar a Managed Services?**

* **Ruta a Campaign v8**: Managed Services proporciona una ruta de actualización más suave a v8 con su interfaz web y capacidades GenAI
* **Escalabilidad y fiabilidad**: aproveche la infraestructura de nube de Adobe para obtener un mejor rendimiento y escalado automático
* **Seguridad mejorada**: benefíciese de supervisión continua, parches de seguridad automáticos y protección de nivel empresarial
* **Soporte experto**: Acceda al equipo de soporte y a los recursos de infraestructura de Adobe
* **Menor sobrecarga de TI** - No se incluye administración de infraestructura, copias de seguridad automáticas ni recuperación ante desastres
* **Integración de Adobe Experience Platform**: integre sin problemas con Adobe Experience Platform para obtener soluciones de marketing completas.

**Consideraciones importantes:**

* **No hay ninguna migración automatizada**. Actualmente no hay ninguna herramienta de migración automatizada disponible. Se requieren la planificación y la ejecución manuales
* **Soporte de Adobe Professional Services**: muy recomendable para atraer a Adobe Professional Services y obtener orientación y experiencia
* **Se requiere preparación** - Organice sus datos, evalúe los requisitos, audite las prácticas actuales y garantice la compatibilidad
* **Complejidad de la migración**: tenga en cuenta factores como la complejidad del entorno, el volumen de datos, las personalizaciones y las dependencias de objetos

**Desafíos clave que se deben planificar para:**

1. **Limitaciones en la importación de datos XML/Blob**: solo se puede importar mediante paquetes o métodos de volcado y restauración
2. **Tablas de datos grandes**: las tablas de destinatarios y los registros de envío/seguimiento requieren estrategias de optimización especiales
3. **Id. de objeto**: cada objeto importado recibe un nuevo Id., por lo que es necesario realinear el Id. para garantizar la continuidad
4. **Actualizaciones de la compilación**: planee actualizar a la última versión disponible v7 antes de la migración

**Guía de migración de alto nivel:**

1. **Debida diligencia y definición del ámbito**: realice un análisis exhaustivo, defina el ámbito y evalúe las necesidades de aprovisionamiento con el equipo de Managed Services de Adobe
2. **Auditoría y perfeccionamiento del ámbito**: revise las prácticas actuales, evalúe los flujos y modelos de datos, identifique las prácticas incorrectas y reduzca los elementos de migración innecesarios
3. **Limpieza y preparación**: solucione los problemas identificados, elimine los datos no utilizados y ejecute las actualizaciones de la compilación a la versión más reciente.
4. **Migración inicial (Fase)**: aprovisionar nueva instancia de nube, estructura de copia de seguridad, importar paquetes, configurar secuencias/contadores, importar objetos, realinear identificadores, importar datos que no sean XML y validar
5. **Migración final (producción)**: actualice la producción con la instancia de fase verificada, realice pruebas de rendimiento, migre directamente a la producción y habilite las capacidades de seguimiento/tiempo real

**Práctica recomendada:** Realice siempre la migración inicial en una instancia de fase antes de continuar con la producción para minimizar los riesgos y validar el proceso.

**Introducción:**

Póngase en contacto con su representante de Adobe y póngase en contacto con Adobe Professional Services para:

* Evalúe su entorno actual y la preparación para la migración
* Desarrollar un plan de migración detallado con plazos y dependencias
* Reciba orientación de expertos durante todo el proceso de migración
* Aproveche las prácticas recomendadas comprobadas y evite los escollos comunes

Más información acerca de [migrar a Managed Services](https://experienceleaguecommunities.adobe.com/t5/adobe-campaign-classic-blogs/migrate-your-adobe-campaign-v7-onprem-hybrid-environment-to/ba-p/681605?profile.language=es){target="_blank"} en la comunidad de Adobe Campaign.

**Temas relacionados:**

[De Campaign Classic v7 a v8](v7-to-v8.md) | [Guía de transición de v7 a v8](https://experienceleague.adobe.com/es/docs/campaign/campaign-v8/new/v7-to-v8){target="_blank"} | [Arquitectura de Campaign v8](../architecture/architecture.md) | [Adobe Professional Services](https://business.adobe.com/es/customers/consulting-services/main.html){target="_blank"}
...
[Matriz de capacidades](https://experienceleague.adobe.com/es/docs/campaign-web/v8/start/capability-matrix){target="_blank"} | [Matriz de compatibilidad](compatibility-matrix.md) | [Protecciones y limitaciones](ac-guardrails.md) | [Guía de transición de v7 a v8](v7-to-v8.md)
...
Los flujos de trabajo de la campaña pueden automatizar prácticamente cualquier proceso de marketing. Estos son los casos de uso más comunes:

**Administración de datos:**

* **Importar y cargar datos**: Automatice las importaciones de archivos desde SFTP, API o almacenamiento en la nube
* **Limpieza de datos**: deduplique perfiles, estandarice formatos y elimine registros no válidos
* **Enriquecimiento de datos**: mejore los perfiles con datos externos o campos calculados
* **Administración de listas**: actualice automáticamente los segmentos según su comportamiento o sus criterios

**Automatización de la campaña:**

* **Serie de bienvenida**: Déclencheur de correos electrónicos de incorporación automatizada para nuevos suscriptores
* **Campañas de cumpleaños**: envía mensajes personalizados en cumpleaños o aniversarios de clientes
* **Reparticipación** - Segmentar suscriptores inactivos con campañas de recuperación
* **Abandono del carro de compras** - Enviar recordatorios a los clientes que dejaron artículos en el carro de compras

**Segmentación avanzada:**

* **Pruebas A/B** - Dividir audiencias y probar diferentes variaciones de contenido
* **Segmentación dinámica**: cree segmentos basados en atributos o comportamientos en tiempo real
* **Puntuación de posibles clientes** - Calcular y actualizar puntuaciones de posibles clientes según la participación
* **Organización en canales múltiples**: coordine la mensajería entre correo electrónico, SMS y push

**Supervisión y alertas:**

* **Supervisión del flujo de trabajo**: efectúe el seguimiento del estado del flujo de trabajo y envíe alertas en caso de errores
* **Supervisión de envíos**: supervise el rendimiento de la campaña y las tasas de devolución
* **Mantenimiento de la base de datos** - Limpieza automática de registros antiguos y datos temporales

**Integración y sincronización:**

* **Sincronización de CRM**: mantenga los datos de los clientes sincronizados con Salesforce, Dynamics, etc.
* **Integraciones de API**: conéctese con plataformas de comercio electrónico, herramientas de análisis o sistemas personalizados
* **Flujos de trabajo activados por eventos**: reaccione a eventos en tiempo real de sitios web o aplicaciones

**Temas relacionados:**

[Biblioteca de casos de uso del flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/about-workflow-use-cases.html){target="_blank"} | [Crear un flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/build-a-workflow.html?lang=es){target="_blank"} | [Prácticas recomendadas de flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/workflow-best-practices.html?lang=es){target="_blank"} | [Flujos de trabajo de segmentación](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/wf-type/targeting-workflows.html?lang=es){target="_blank"} | [Flujos de trabajo de administración de datos](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/data-management/about-data-management.html){target="_blank"}
...
[Actividades de administración de datos](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/about-targeting-activities.html){target="_blank"} | [Flujos de trabajo de segmentación](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/wf-type/targeting-workflows.html?lang=es){target="_blank"} | [Actividad de enriquecimiento](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/enrichment.html?lang=es){target="_blank"}
...
[Guía de Personalization](../send/personalize.md) | [Casos de uso del flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/deliveries/send-a-birthday-email.html?lang=es){target="_blank"} | [Actividad de enriquecimiento](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/enrichment.html?lang=es){target="_blank"}
...
[Actividad de consulta](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/query.html?lang=es){target="_blank"} | [Uso de agregados](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/data-management/using-aggregates.html?lang=es){target="_blank"} | [Programas de bienvenida](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/deliveries/send-a-birthday-email.html?lang=es){target="_blank"}
...
[Referencia de actividades de segmentación](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/targeting-activities.html?lang=es){target="_blank"} | [Referencia de actividades de control de flujo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/flow-control-activities/flow-control-activities.html?lang=es){target="_blank"} | [Referencia de actividades de acción](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/action-activities/action-activities.html?lang=es){target="_blank"} | [Referencia de actividades de eventos](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/event-activities/event-activities.html?lang=es){target="_blank"}
...
[Guía de prácticas recomendadas de flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/workflow-best-practices.html?lang=es){target="_blank"} | [Crear un flujo de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/build-a-workflow.html?lang=es){target="_blank"} | [Supervisar flujos de trabajo](https://experienceleague.adobe.com/docs/campaign/automation/workflows/monitoring-workflows/monitor-workflow-execution.html?lang=es){target="_blank"}
...
Más información sobre cómo [trabajar con paquetes de datos](../dev/packages.md)
...
Todos los comandos de control de flujo de trabajo utilizan el mismo extremo POST con parámetros de método diferentes:

`POST https://mc.adobe.io/<ORGANIZATION>/campaign/workflow/execution/<workflowID>/commands`

**Comandos disponibles:**

* `{"method":"start"}` - Iniciar un flujo de trabajo
* `{"method":"pause"}` - Pausar un flujo de trabajo en ejecución
* `{"method":"resume"}` - Reanudar un flujo de trabajo pausado
* `{"method":"stop"}` - Detener un flujo de trabajo
...
Obtenga información sobre cómo [controlar flujos de trabajo mediante API](../dev/api/controlling-a-workflow.md)
