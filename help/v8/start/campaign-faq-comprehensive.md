...
**Nota:** Si necesita una implementación local o híbrida, Campaign Classic v7 sigue estando disponible y es totalmente compatible.
...
* **Registros de flujo de trabajo**: acceda a los registros de ejecución detallados para solucionar problemas
* **Mapa de calor**: visualice la actividad del flujo de trabajo e identifique cuellos de botella de rendimiento
...
* **Alertas**: configure notificaciones para errores o retrasos del flujo de trabajo
