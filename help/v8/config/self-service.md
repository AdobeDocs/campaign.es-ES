...
Obtenga más información en [Panel de control de Campaign de Campaign](https://experienceleague.adobe.com/docs/control-panel/using/control-panel-home.html?lang=es){target="_blank"}.
...
>
>Revise cuidadosamente el nombre de su Perfil de producto para asegurarse de que solo los usuarios autorizados tengan acceso al Panel de control de Campaign.
...
En Campaign v8 Managed Cloud Services, Adobe también supervisa los procesos de infraestructura, plataforma y software en su nombre. Más información sobre la [supervisión administrada por Adobe](../start/monitor.md#adobe-cloud-monitoring).
